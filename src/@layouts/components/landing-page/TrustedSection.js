...
export default function TrustedSection() {
  return (
    <section className="py-16 bg-green-50 bg-[radial-gradient(circle,rgba(0,0,0,0.1)_1px,transparent_1px)] bg-[length:20px_20px] w-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-20 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          <div className="flex items-center justify-center lg:justify-start gap-3 mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold leading-snug">
              Trusted by Thousands,<br className="hidden sm:block"/> Growing Every Day
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10 mt-10">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-xl sm:text-2xl font-bold">2,03,400+</p>
        ...
        <div className="lg:w-1/2 flex justify-center">
          <img
            src="https://finkeda.com/wp-content/themes/finkeda/assets/images/map.png"
            alt="India Map"
